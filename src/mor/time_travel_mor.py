...
output_path = "s3a://gaurav-hudi-data/my_hudi_table_mor"
spark.sparkContext.setLogLevel("ERROR")

df1 = (
    spark.read.format("hudi")
    .option("as.of.instant", "20260122093503824")
    .load(output_path)
)
...
df2 = (
    spark.read.format("hudi")
    .option("as.of.instant", "20260122093839487")
    .load(output_path)
)
...
df3 = (
    spark.read.format("hudi")
    .option("as.of.instant", "20260122094708252")
    .load(output_path)
)
...
print(f"\nTotal rows at current instant: {df4.count()}")